...
int main(int argc, char *argv[])
{
	...
	baseTrans->setLocalPosition(glm::vec3(0.0f, 1.0f, -5.0f));
	...
	//perspective matrix
	testShad->setUniform("in_Projection", glm::perspective(glm::radians(45.0f), (float)(800.0f / 600.0f), 0.1f, 1000.0f));
	...
	camera = glm::translate(camera, glm::vec3(1.0f, 0, 5.0f));
